...
LOCAL_APPS = [
    "e_commerce.users.apps.UsersConfig",
    # Your stuff: custom apps go here
    "e_commerce.stores.apps.StoresConfig",
    "e_commerce.basket.apps.BasketConfig",
]
...
ADMINS = [("""Pratap Kute""", "pratap.kute97@gmail.com")]
